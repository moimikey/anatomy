...
Class GFNotification{
    ...
    public static function notification_page($form_id, $notification_id) {
        ...
        if(rgpost("save")){
            ...
            $notification = apply_filters( 'gform_notification_before_save', apply_filters( "gform_notification_before_save_{$form['id']}", $notification, $form ), $form );
    ...
    private static function get_notification_ui_settings($notification) {
        ...
        <tr valign="top" <?php echo $event_style ?>>
            ...
            <td>
                ...
                foreach($notification_events as $code => $label){
                    ?>
                    <option value="<?php echo esc_attr($code) ?>" <?php selected($notification["event"], $code)?>><?php echo esc_html($label) ?></option>
                    <?php
                }
                ?>
                </select>
        ...
        <tr id="gform_notification_to_routing_container" class="notification_to_container <?php echo $send_to_class ?>" <?php echo $notification_to_type != "routing" ? "style='display:none';" : ""?>>
            <th scope="row"><?php _e("Routing", "gravityforms") ?></th>
            <td>
                <div id="gform_notification_to_routing_rules">
                    ...
                    if(empty($routing_fields)){//if(empty(){
                        ...
                        for($i=0; $i<$count; $i++){
                            ...
                            $is_invalid_rule = !$is_valid && $_POST["gform_notification_to_type"] == "routing" && !self::is_valid_notification_email($routing["email"]);
        ...
        <tr valign="top" <?php echo $message_class ?>>
            ...
            <td>
                ...
                if(GFCommon::is_wp_version("3.3")){
                    wp_editor(rgar($notification,"message"), "gform_notification_message", array("autop"=>false));
                }
                else{?>
        ...
        <tr valign="top">
            ...
            <td>
                ...
                <br/>
                <div id="notification_conditional_logic_container" style="display:none; padding-top:10px;">
