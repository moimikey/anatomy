...
class GFFormSettings {
        ...
        */
        ...
        function SaveFormSettings() {
            ...
            if(window["gform_before_update"]){
                ...
                if(window.console)
                    console.log('"gform_before_update" is deprecated since version 1.7! Use "gform_before_form_settings_update" or "gform_before_form_editor_update" filters instead.');
            }

            // new method for filtering the form object before save
            form = gform.applyFilters('gform_before_form_settings_update', form);
    ...
    public static function get_confirmation_ui_settings($confirmation) {
        ...
        <tr id="form_confirmation_message_container" <?php echo $confirmation_type != "message" ? 'style="display:none;"' : ""; ?> >
            <th><?php _e('Confirmation Message'); ?></th>
            <td>
        ...
        <tr id="form_confirmation_page_container" <?php echo $confirmation_type != "page" ? 'style="display:none;"' : ""?> class="<?php echo $class; ?>">
            <th><?php _e('Confirmation Page'); ?></th>
            <td>
    ...
    public static function notification_edit_page($form_id, $notification_id) {
        ...
        GFNotification::notification_page($form_id, $notification_id);
    ...
    public static function notification_list_page($form_id) {
        ...
        self::page_header(__('Notifications', 'gravityforms'));
    ...
    public static function page_header($title = ''){
        ...
        wp_register_style('jquery-ui-styles', GFCommon::get_base_url() . '/css/jquery-ui-1.7.2.custom.css');
        ...
        <div class="wrap gforms_edit_form <?php echo GFCommon::get_browser_class() ?>">
            ...
            <div id="gravity-edit-icon" class="icon32"></div>
    ...
    public static function handle_confirmation_edit_submission($confirmation, $form) {
        ...
        $confirmation = apply_filters("gform_confirmation_before_save_{$form['id']}", apply_filters('gform_confirmation_before_save', $confirmation, $form), $form);
