...
class GFCommon{
    ...
    public static $version = "1.7.beta1";
    ...
    public static function send_notification($notification, $form, $lead){
        ...
        $attachments = is_array(rgar($notification, "attachments")) ? rgar($notification, "attachments") : array();
    ...
    private static function send_email($from, $to, $bcc, $reply_to, $subject, $message, $from_name="", $message_format="html", $attachments=""){
        ...
        $abort_email = false;
        extract(apply_filters("gform_before_email", compact("to", "subject", "message", "headers", "attachments", "abort_email"), $message_format));
