...
class GFFormsModel {
    ...
    public static function save_lead($form, &$lead){
        ...
        if($total_field) {
            ...
            GFCommon::log_debug("Saving total field {$calculation_field["label"]}");
    ...
    */
    public static function convert_confirmation($form) {
        ...
        $confirmation['type'] = $confirmation['type'] ? $confirmation['type'] : "message";

        if($confirmation['type'] == 'message')
            $confirmation['message'] = esc_html(__("Thanks for contacting us! We will get in touch with you shortly.", "gravityforms"));
